...
For a long time, I'm using mouse like A4Tech Oscar X-748K (earlier DeLux M555, and another Laser Oscar X-7xx) 
...
Furthermore, I got a keyboard (to replace my lovely blue switches :( coz it's too noisy...) 
...
cd source cinnamon-settings-daemon-xx
```
